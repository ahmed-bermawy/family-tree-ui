...
### Added
- ✏️ **Edit gender** — the edit modal (single person) and edit couple modal now let you change each person's gender (♂ Male / ♀ Female), with the current gender pre-selected. Gender is sent with the name when saving.
